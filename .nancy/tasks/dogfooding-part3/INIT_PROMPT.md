...
# Task Initialization - dogfooding-part3
...
- **DO NOT** create new tasks - task 'dogfooding-part3' already exists
- **Your job**: Create SPEC.md in `/Users/alphab/Dev/LLM/DEV/md-tldr/.ralph/tasks/dogfooding-part3/`
...
Once requirements are clear, create `/Users/alphab/Dev/LLM/DEV/md-tldr/.ralph/tasks/dogfooding-part3/SPEC.md`:

```markdown
# Task: dogfooding-part3
...
Start: "What would you like Ralph to work on for 'dogfooding-part3'?"
