...
- [x] Can extract context for specific sections by name or number
- [x] Search results can show context lines around matches (-C flag)
- [x] Truncation warning appears at TOP of output with actionable guidance
- [x] `--sections` flag lists available sections for targeted retrieval
- [x] All existing tests pass
- [x] New tests cover section extraction and context lines
- [x] Help text (help.ts) includes section filtering examples
- [x] README.md documents --section, --sections, --shallow flags
