# Ralph Worker - embeddings-ux

**Session:** `ralph-embeddings-ux-iter2`
...
- Commit progress: `ralph(embeddings-ux): <detailed_description>`
...
**Only then:**
```bash
echo "done" > .ralph/tasks/embeddings-ux/COMPLETE
```
